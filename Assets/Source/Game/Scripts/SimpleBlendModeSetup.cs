...
namespace OTS.Rendering
{
    ...
    public class SimpleBlendModeSetup : MonoBehaviour
    {
        ...
        public void CreateTestSprites()
        {
            ...
            CreateSprite("Layer1", Color.green, BlendMode.Multiply, new Vector3(0, -1, 0));
            CreateSprite("Layer2", Color.blue, BlendMode.Screen, new Vector3(-0.5f, 0, 0));
            CreateSprite("Layer3", Color.yellow, BlendMode.Overlay, new Vector3(0.5f, 0, 0));
